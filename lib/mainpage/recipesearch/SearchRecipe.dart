...
List<Map<String, dynamic>> SrecipeData = [];  //SearchRecipe1
List<Map<String, dynamic>> SearchRecipeData2 = [];  //SearchRecipe2

Future<Map<String, dynamic>> SearchRecipe1(String recipeName) async {
// FutureOr<QuerySnapshot<Object?>> SearchRecipe1(String recipeName) async {
  print("進入搜尋食譜2");
  ...
  if (querySnapshot.docs.isNotEmpty) {
    ...
    SrecipeData = querySnapshot.docs.map((document) {
  ...
  print(SrecipeData);
    ...
    return SrecipeData.isNotEmpty ? SrecipeData[0] : {};
...
Future<List<Map<String, dynamic>>> SearchRecipe2(String recipeName) async {

  try {
    SearchRecipeData2.clear();
    ...
    return SearchRecipeData2.toList();
  } catch (e) {
    print('Error: $e');
    return [];
  }
